...
from utils.model import BertForSequenceClassification, \
                  ...
                  GeneralModelForSequenceClassification, \
                  GeneralModelForNaturalLanguageInference, \
                  GeneralModelForDialogueActionPrediction, \
                  GeneralModelForResponseSelection
        ...
        def get_model_class(args):
            if args.TASK in ['seq', 'oos']:
                if 'distil' in args.model_type:
                    ...
                    return GeneralModelForSequenceClassification
            elif args.TASK == 'nli':
                if 'distil' in args.model_type:
                    ...
                    return GeneralModelForNaturalLanguageInference
            elif args.TASK == 'da':
                if 'distil' in args.model_type:
                    ...
                    return GeneralModelForDialogueActionPrediction
            elif args.TASK == 'rs':
                if 'distil' in args.model_type:
                    ...
                    return GeneralModelForResponseSelection
            else:
                raise ValueError("Please choose TASK from ['seq', 'oos', 'nli', 'da', 'rs']")
