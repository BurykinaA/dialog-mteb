...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./short_combined_model", help="Directory to save the trained model.")
    ...
    parser.add_argument("--teacher_update_epochs", type=int, default=2, help="Frequency (in epochs) to update the teacher model.")
